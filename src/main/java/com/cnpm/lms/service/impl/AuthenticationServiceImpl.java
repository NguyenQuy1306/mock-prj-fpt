...
import com.cnpm.lms.model.response.ResponseCode;
import com.cnpm.lms.model.response.UserResponse;
import com.cnpm.lms.repository.RefreshTokenRepository;
import com.cnpm.lms.repository.TokenRepository;
import com.cnpm.lms.repository.UserRepository;
import com.cnpm.lms.service.AuthenticationService;
import com.cnpm.lms.service.CookieService;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public UserResponse register(RegisterRequest request) {
        try {
            ...
            user.setAvtUrl(
                    "https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.vecteezy.com%2Ffree-vector%2Fuser-icon&psig=AOvVaw2pZJaxsovqmDuBsUPr-0nA&ust=1721966244522000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCJCVs5mmwYcDFQAAAAAdAAAAABAE");
