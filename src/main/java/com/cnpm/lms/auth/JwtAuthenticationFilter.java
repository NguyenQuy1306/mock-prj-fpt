...
import com.cnpm.lms.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            // this.userDetailsServiceImpl.loadUserByUsername(userEmail);
            ...
            // .orElse(false);
            //
            // if (jwtServiceImpl.isTokenValid(accessToken, userDetails) &&
            // isAccessTokenValid) {
            //
            ...
            // && isRefreshTokenValid
            // && !(jwtServiceImpl.isTokenValid(accessToken, userDetails) &&
            // isAccessTokenValid)) {
            //
            ...
            var isAccessTokenValid = tokenRepository.findByToken(jwt)
                    ...
                    .orElse(false);
            // refreshToken =
            // refreshTokenRepository.findByUser_UserId(userDetails.getUser().getUserId()).orElse(null);
